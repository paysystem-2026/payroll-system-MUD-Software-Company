...
export const payrollService = {
  ...
  deleteHistory: (periodId:number) => invokeCommand<PayrollPeriodResponse>("delete_payroll_history", { periodId }, periodResponse),
  clearHistory: () => invokeCommand<PayrollPeriodResponse>("clear_payroll_history", undefined, periodResponse),
  ...
  deleteLoan: (loanId:number) => invokeCommand<PayrollPeriodResponse>("delete_loan", { loanId }, periodResponse),
  clearLoans: () => invokeCommand<PayrollPeriodResponse>("clear_loans", undefined, periodResponse),
